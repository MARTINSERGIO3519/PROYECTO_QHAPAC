...
export default function Quizz5() {
  ...
  const seleccionarRespuesta = async (index) => {
    ...
    const nuevaPuntuacion = index === preguntasNivel5[actual].correcta ? puntaje + 1 : puntaje;
      ...
      <div className="bg-white p-5 rounded-xl shadow max-w-xl mx-auto">
        ...
        {loading ? (
          ...
          <>
            ...
            <p className="mb-4 text-lg">{preguntasNivel5[actual].pregunta}</p>
          ...
          <div className="text-center">
            ...
            <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
              <p className="text-lg font-semibold">Puntaje: {puntaje} / {preguntasNivel5.length}</p>
